"""Canonical benchmark system messages shared by model and agent runners."""
...
def system_messages_sha256() -> str:
    """Fingerprint the exact canonical system messages used for a run."""
